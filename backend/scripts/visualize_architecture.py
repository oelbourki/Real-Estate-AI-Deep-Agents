    ...
    def visualize_langgraph_architecture():
        ...
        if hasattr(compiled_graph, "get_graph"):
            ...
            try:
                ...
                print(
                    "   Note: This requires additional dependencies (PIL/Pillow, pygraphviz, etc.)"
                )
                print(
                    "   The Mermaid diagram is still available in docs/langgraph_architecture.mmd"
                )
            ...
            if image_path.exists():
                print(
                    f"  - assets/langgraph_architecture.png (PNG image - {image_path.stat().st_size:,} bytes)"
                )
            ...
            print(
                f"Available methods: {[m for m in dir(compiled_graph) if not m.startswith('_')]}"
            )
